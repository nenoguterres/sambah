  ...
  return createServer(async (req, res) => {
    try {
      ...
      if (req.method === "POST" && ["/webhook/whatsapp", "/webhook/site"].includes(url.pathname)) {
        return handleWhatsAppWebhook(req, res, auditService, mesaService, menuService, conversationService, whatsappConversationService, draftService, eventService, trackingService, crmService, whatsappMessageService, callCenterService, eventEmailAlertService, whatsappSendFetch, appWhatsappProvider, appRuntimeConfig);
      }
...
async function handleWhatsAppWebhook(req, res, auditService, mesaService, menuService, conversationService, whatsappConversationService, draftService, eventService, trackingService, crmService, whatsappMessageService, callCenterService = null, eventEmailAlertService = null, whatsappSendFetch = globalThis.fetch, appWhatsappProvider = whatsappProvider, appRuntimeConfig = null) {
  let body = {};
  try {
